...
import { getSports, getSport } from '../../services/turfAxios';
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          ...
          if (imageUpdated) {
            ...
            const { data } = await axios.post(`https://api.cloudinary.com/v1_1/dywzfpbux/image/upload`, formData);
          ...
          if (documentUpdated) {
            ...
            formData.append("upload_preset", uploadPreset);
            const response = await axios.post(`https://api.cloudinary.com/v1_1/dywzfpbux/image/upload`, formData);
