...
// import PreviewImage from "../../vendor/PreviewImage";
// import axios from "../../../api/axios";
// import { addVenue, getSports } from "../../../services/turfAxios";
...
// const acessToken = 'pk.eyJ1IjoibW9oc2luMzEyMCIsImEiOiJjbGpwOXh1ZDIwZzVxM2RzOXR5NXd4NTZmIn0.tWKi1GdW9t7a77D3kybUnw'
...
//                 const response = await addVenue(documents);
//                 if (response.status === 200) {
//                   toast.success('Turf added successfully!');
//                 } else{
//                   toast.error('There was an error when adding turf');
//                 }
//               } catch (error) {
//                 toast.error('There was an error when adding turf');
//                 console.log(error.message);
...
//             <div className="fixed m-12 inset-0 top-0 flex items-start justify-center">
//                 <div className="bg-white rounded-lg p-6 overflow-y-auto max-h-full">
...
//                                                             <p className="text-sm text-red-600">{formik.errors.sport}</p>
//                                                         ) : null}
//                                                     </div>
...
//                                                                     <p className="text-sm text-red-600">{formik.errors.facility}</p>
//                                                                 ) : null}
//                                                             </>
//                                                         )}
//                                                     </div>
...
//                                                             sports.map((sport) => (
//                                                                 <div key={sport._id}>
//                                                                     <label htmlFor={sport.sport}>{sport.sport}</label>
//                                                                     <input type="checkbox" id={sport.sport} name={sport.sport} value={sport.sport} />
//                                                                 </div>
//                                                             ))}
//                                                     </div>
//                                                 </div>
