...
import { getSports, addVenue } from '../../services/turfAxios';
...
function VeneuAdd() {
    ...
    const Geocoder = () => {
        const ctrl = new MapboxGeocoder({
            accessToken: 'pk.eyJ1IjoibW9oc2luMzEyMCIsImEiOiJjbGpwOXh1ZDIwZzVxM2RzOXR5NXd4NTZmIn0.tWKi1GdW9t7a77D3kybUnw',
            marker: false,
            collapsed: true,
        });
        useControl(() => ctrl);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const uploadPreset = 'ugiq1hrs'
            formData.append("file", image);
            formData.append("upload_preset", uploadPreset);
            var { data } = await axios.post(`https://api.cloudinary.com/v1_1/dywzfpbux/image/upload`, formData);
        ...
        try {
            const details  = { venueName, mobile, district, place, actualPrice, discountPercentage, description, image: imageUrl, document: documentUrl, slots, sportFacility, lat, lng }
            console.log(details);
            let response = await addVenue(details)
    ...
    return (
        <div className="bg-emerald-900 overflow-hidden mt-16 pb-60 flex flex-nowrap">
            <form className="p-4 mt-14" onSubmit={(e) => handleSubmit(e)}>
                <Link to="/vendor/venues" className="p-1.5 hover:bg-blue-600 duration-200 bg-blue-500 rounded text-white">
                    Back
                </Link>
                <div className="flex gap-x-4 ">
                    <div className="mt-3 w-1/2 ">
                        ...
                        <input
                            type="text"
                            name="name"
                            className="bg-gray-100/50 block placeholder:text-black  focus:outline-none rounded focus:border-b-2 focus:border-green-600 p-2 w-full shadow-inner capitalize"
                    ...
                    <div className="mt-3 w-1/3 ">
                        ...
                        <input
                            type="number"
                            name="mobile"
                            className="bg-gray-100/50 block  placeholder:text-black  focus:outline-none rounded focus:border-b-2 focus:border-green-600 p-2 w-full shadow-inner "
                    ...
                    <div className="mt-3 w-1/3 ">
                        <label htmlFor="address" className=" block text-sm text-white">
                            Place
                        </label>
                        <input
                            type="text"
                ...
                <div className="flex gap-x-4">
                    <div className="flex-col w-2/4">
                        <div className="flex gap-x-4 ">
                            <div className="mt-3 w-2/4 ">
                                ...
                                <select
                                    ...
                                    name="name"
                                    className="bg-gray-100/50 block  placeholder:text-black  focus:outline-none  focus:border-b-2 focus:border-green-600 p-2 w-full shadow-inner capitalize"
                                    required
                                >
                        ...
                        <div className="flex flex-wrap">
                            <div className="mt-3 w-1/2">
                                <label htmlFor="image" className="block text-sm text-white">
                                    Image
                                </label>
                                <div className="flex items-center gap-1 ">
                                    <label htmlFor="image" className=" cursor-pointer p-2 rounded text-white bg-gray-100/50 shadow-inner focus:outline-none ">
                            ...
                            <div className="mt-3">
                                <label htmlFor="document" className="block text-sm text-white">
                                    Document
                                </label>
                                <div className="flex items-center gap-1">
                    ...
                    <div className="w-2/4">
                        <div class="mt-3 w-full">
                            ...
                            <textarea
                                ...
                                class="bg-gray-100/50  placeholder:text-black  focus:outline-none shadow-inner p-2 focus:border-b-2 focus:border-green-600 block w-full border-gray-300 rounded"
                            ></textarea>
                        </div>
                    </div>
                </div>
                <div className="flex w-full h-96 gap-x-4 mt-3">
                    <div className="w-1/2 h-auto ">
                        <ReactMapGL
                            mapboxAccessToken='pk.eyJ1IjoibW9oc2luMzEyMCIsImEiOiJjbGpwOXh1ZDIwZzVxM2RzOXR5NXd4NTZmIn0.tWKi1GdW9t7a77D3kybUnw'
                            initialViewState={{
                                longitude: lng,
                                latitude: lat,
                                zoom: 6,
                    ...
                    <div className="mt-3 w-1/2 flex">
                        <div className="w-7/12">
                            <label className=" text-sm text-white">Slot by days</label>
                            ...
                            <div className="flex gap-3 mt-2 mb-14 h-100 flex-wrap">
                                {slotLoading ? (
                        ...
                        <div className="w-5/12">
                            ...
                            {sports.length ? (
                                sports.map((sport, key) => (
                                    <div className="flex items-center gap-4 p-2 bg-gray-100/50 mt-2 rounded shadow-inner" key={key}>
                                        <div className=" flex flex-wrap">
                                            <input
                                                type="checkbox"
                                                className="rounded"
