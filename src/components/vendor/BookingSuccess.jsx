...
import { bookingDetails} from '../../services/turfAxios';
...
function BookingSuccess() {
  ...
  return (
    <div>
      <div className="w-full bg-slate-950 opacity-90 min-h-full px-7 py-10 mt-16 ">
        <div className="p-1 rounded-lg dark:border-gray-700 mt-14">
          {loading ? (
