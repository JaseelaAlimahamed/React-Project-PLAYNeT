...
const MOBILE_URL = "/vendor/vendorMobile";
const SIGN_UP = "/vendor/vendorSignup";
      ...
      onSubmit: async (values) => {
        ...
        try {
          ...
          if (error.message === "Firebase: Error (auth/invalid-verification-code).") {
            ...
            setErr("Otp Expired Please Retry")
    ...
    return (
      <div className="bg-gradient-to-r min-h-screen from-black to-slate-950 opacity-80 py-32 sm:px-16 lg:px-32 xl:px-72 ">
        <div className="container">
          ...
          <div className="w-full h-45 bg-green-800 shadow-md rounded-md p-8 space-y-6 ">
            <div className="space-y-1 ">
              <h1 className="font-semibold">
                hey, <span className="text-3xl font-roboto font-bold">Venue Manager.</span>
              </h1>
              <p>Let's get rolling..PLAYNeT !!.</p>
            </div>
            {!success ? (
              <form onSubmit={formik.handleSubmit}>
                ...
                <div className="grid sm:grid-cols-2 gap-2">
                  ...
                  <button type="submit" className="w-2/4 select-none p-2 rounded-full text-white text-xl font-roboto  font-semibold bg-green-900 hover:bg-green-400/70">
                    Sign up
                  </button>
                </div>
