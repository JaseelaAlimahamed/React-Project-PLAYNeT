...
import { Wallet } from "./images/Wallets";
import { updateWallet, changeName, userLogout } from '../../redux/slices/userSlice'
import { Navigate } from "react-router-dom";
import { cancelBooking, getBookings, nameChange } from "../../services/userAxios";
...
function ProfilePage() {
    ...
    const handleChangeName = async () => {
        ...
        try {
            const data = await nameChange(name)
    ...
    const handleCancelBooking = async (bookingId, bookedDate, bookedTime) => {
        try {
