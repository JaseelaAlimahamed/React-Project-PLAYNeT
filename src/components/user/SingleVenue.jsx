...
import { LocationIcon,GetDirection,PercentageRound } from './images/Icons'
import { Cricket,Football,Badminton } from './images/Sports'


function SingleVenue({turf,part,setPart}) {
        ...
        <div>
          <div className='bg-white '>
            <div className='container '>
              <div className='flex flex-col md:flex-row w-full mt-16 p-4'>
