...
import { setAdminLoggedIn } from '../../redux/slices/adminSlice'
            ...
            <div className="h-45 rounded-md md:px-28 lg:px-16 space-y-6">
              <div className="bg-white w-80 sm:w-96 shadow-md p-8">
                ...
                <div className="mt-2 space-y-3 items-center">
                  ...
                  <button
                    type="submit"
                    className="duration-300 select-none p-2 mt-2 w-2/3 rounded-full text-white text-xl font-roboto  font-semibold bg-green-400/70 hover:bg-green-500"
                  >
                    Sign in
                  </button>
